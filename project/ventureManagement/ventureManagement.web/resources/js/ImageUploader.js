...
ImageUploader.prototype.performUpload = function(imageData, completionCallback) {
    ...
    if (this.config.debug) {
        ...
        var c = this.config.workspace.insertCell();
        resizedImage.style.maxWidth = This.config.displayMaxWidth;
        resizedImage.style.maxHeight = This.config.displayMaxHeight;
        resizedImage.src = imageData;
        c.appendChild(resizedImage);
    }
};
...
ImageUploader.prototype.setConfig = function(customConfig) {
    ...
    if (!this.config.workspace) {
        ...
        this.config.workspace = table.insertRow();
        this.config.imgContainer.appendChild(table);
    }
};
